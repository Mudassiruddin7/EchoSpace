                ...
                subscription = supabase
                    ...
                    .on(
                        ...
                        (payload) => {
                            ...
                            setMessages(prev => {
                                ...
                                console.log('✅ Message added:', newMessage.username);
                    ...
                    .subscribe((status, err) => {
                        ...
                        if (status === 'SUBSCRIBED') {
                            console.log('✅ Successfully subscribed to room chat');
                            retryCountRef.current = 0; // Reset retry count on success
                            stopPolling();
                        } else if (status === 'CHANNEL_ERROR') {
                            console.error('❌ Chat subscription failed - falling back to polling');
